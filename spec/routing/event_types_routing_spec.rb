...
describe EventTypesController do
  describe "routing" do
    ...
    it "routes to #new" do
      get("/event_types/new").should route_to("event_types#new")
    end
    ...
    it "routes to #create" do
      post("/event_types").should route_to("event_types#create")
    end
    ...
    it "routes to #destroy" do
      delete("/event_types/1").should route_to("event_types#destroy", :id => "1")
    end
