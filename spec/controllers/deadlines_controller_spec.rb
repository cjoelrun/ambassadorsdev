...
describe DeadlinesController do
  ...
  describe "GET new" do
    it "assigns a new deadline as @deadline" do
      get :new, {}, valid_session
      assigns(:deadline).should be_a_new(Deadline)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Deadline" do
        expect {
          post :create, {:deadline => valid_attributes}, valid_session
        }.to change(Deadline, :count).by(1)
      end

      it "assigns a newly created deadline as @deadline" do
        post :create, {:deadline => valid_attributes}, valid_session
        assigns(:deadline).should be_a(Deadline)
        assigns(:deadline).should be_persisted
      end

      it "redirects to the created deadline" do
        post :create, {:deadline => valid_attributes}, valid_session
        response.should redirect_to(Deadline.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved deadline as @deadline" do
        ...
        post :create, {:deadline => {}}, valid_session
        assigns(:deadline).should be_a_new(Deadline)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested deadline" do
        ...
        Deadline.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => deadline.to_param, :deadline => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the deadline as @deadline" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Deadline.any_instance.stub(:save).and_return(false)
        put :update, {:id => deadline.to_param, :deadline => {}}, valid_session
        assigns(:deadline).should eq(deadline)
      end
